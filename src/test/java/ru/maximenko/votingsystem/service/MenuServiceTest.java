...
public class MenuServiceTest extends AbstractServiceTest {
    ...
    @Test
    public void getOne() {
        Menu actual = menuService.get(MENU1_ID, RESTAURANT1_ID);
        assertThat(actual).usingRecursiveComparison().ignoringFields("dateChange").isEqualTo(menu1);
    }

    @Test
    public void getNotOwn() {
        assertThrows(EntityNotFoundException.class, () -> menuService.get(MENU1_ID, RESTAURANT2_ID));
    }
    ...
    public void update() {
        ...
        assertThat(menuService.get(MENU2_ID, RESTAURANT1_ID)).usingRecursiveComparison().ignoringFields("dateChange").isEqualTo(getUpdated());
    }

    @Test
    public void updateNotOwn() {
        EntityNotFoundException ex = assertThrows(EntityNotFoundException.class, () -> menuService.update(getUpdated(), RESTAURANT2_ID));
        assertEquals("Not found entity with id = " + (MENU2_ID), ex.getMessage());
        assertThat(menuService.get(MENU2_ID, RESTAURANT1_ID)).usingRecursiveComparison().ignoringFields("dateChange").isEqualTo(menu2);
    }

    @Test
    public void delete() {
        menuService.delete(MENU7_ID, RESTAURANT2_ID);
        assertThrows(EntityNotFoundException.class, () -> menuService.get(MENU7_ID, RESTAURANT2_ID));
    }

    @Test
    public void deleteNotFound() {
        menuService.delete(MENU6_ID, RESTAURANT2_ID);
        assertThrows(EntityNotFoundException.class, () -> menuService.delete(MENU6_ID, RESTAURANT2_ID));
        assertThrows(EntityNotFoundException.class, () -> menuService.delete(NOT_FOUND, RESTAURANT2_ID));
    }

    @Test
    public void deleteNotOwn() {
        assertThrows(EntityNotFoundException.class, () -> menuService.delete(MENU1_ID, RESTAURANT2_ID));
    }
